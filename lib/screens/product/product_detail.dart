...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        product = productItems.firstWhere(
          (p) => p['id'] == args.id,
          orElse: () => {},
        );
  ...
  Widget build(BuildContext context){
    ...
    var product = productItems.firstWhere((product) => product['id'] == args.id, orElse: () => {});
                    ...
                    children: [
                      Container(
                        ...
                        child: Stack(
                          children: [
                             if (imagePath != null)
                            Image.asset(imagePath!,fit: BoxFit.cover,width: double.maxFinite,),
                            ...
                            Positioned(
                              ...
                              child:Container(
                                ...
                                child : SingleChildScrollView(
                                  ...
                                  child: Column(
                                    children: (product['images'] as List<Map<String, String>>).map((item) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Expanded(child: Text('Thivi Blouse', style: Theme.of(context).textTheme.titleMedium?.merge(TextStyle(fontWeight: FontWeight.w500,color: IKColors.primary)), )),
                                const Icon(
                                  Icons.star,
                                  size: 16,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                      ...
                                      Row(
                                        children: [
                                          Text('\$${product["price"]}',style: Theme.of(context).textTheme.headlineLarge?.merge(const TextStyle(fontWeight: FontWeight.bold,color: IKColors.primary))),
                                          const SizedBox(width: 6),
                                          Text('\$${product["old-price"]}',style: Theme.of(context).textTheme.titleMedium?.merge(TextStyle(decoration: TextDecoration.lineThrough,fontWeight: FontWeight.w300,fontSize: 15))),
                                        ],
                                      )
                                  ],
                                ),
