...
class Onboarding extends StatelessWidget {
  ...
  final List<Map<String, String>> images = [
    {
      'title': 'Welcome to JC Cart Tele Caller App',
      'description':
          'Streamline your calls and manage customer interactions effortlessly.',
    },
    {
      'title': 'Stay Organized, Stay Ahead',
      'description':
          'Keep track of every call, follow-up, and customer interaction with ease.',
    },
    {
      'title': 'Connect. Engage. Convert.',
      'description':
          'Manage calls, track leads, and boost sales—all in one app.',
    },
  ];
            ...
            children: [
              Expanded(
                ...
                children: [
                  ...
                  RotatedBox(
                      quarterTurns: 1,
                      child: Text('JC MART'.toUpperCase(),
