                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.circular(IKSizes.borderRadiusSm)),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Container(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor:
                                        const Color.fromARGB(40, 235, 87, 87),
                                    side: const BorderSide(
                                        color: Color.fromARGB(40, 235, 87, 87)),
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                      backgroundColor:
                                          const Color.fromARGB(40, 33, 150, 84),
                                      side: const BorderSide(
                                          color:
                                              Color.fromARGB(40, 33, 150, 84)),
