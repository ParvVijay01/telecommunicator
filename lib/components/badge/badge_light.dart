            ...
            child: Opacity(
              ...
              child: Container(
                decoration: BoxDecoration(
                    ...
                    borderRadius:
                        BorderRadius.circular(rounded == true ? 20 : 4)),
              ),
            )),
        Container(
          ...
          child: Text(title,
              style: size == 'lg'
                  ? Theme.of(context).textTheme.bodyLarge?.merge(
                      TextStyle(color: textColor ?? color ?? IKColors.primary))
                  : size == 'md'
                      ? Theme.of(context).textTheme.bodyMedium?.merge(TextStyle(
                          color: textColor ?? color ?? IKColors.primary))
                      : Theme.of(context).textTheme.bodySmall?.merge(TextStyle(
                          color: textColor ?? color ?? IKColors.primary))),
        ),
      ],
    );
